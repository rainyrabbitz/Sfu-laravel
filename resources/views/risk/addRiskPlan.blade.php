...
@section('content')
    ...
    <div class="container-fluid">
        <div class="col-md-12 text-center">
            <h2>
                <p style="color: #5c7cef">เพิ่มไฟล์ของ
                    <span class="header2"> แผนการประเมินผลการบริหารความเสี่ยงและการควบคุมภายใน อผม.</span></p>
            </h2>
        </div>
        <div class="col-md-12">
        ...
        <form class="col-md-offset-3 col-md-6 text-center" action="/risk-plan" method="post" enctype="multipart/form-data">
